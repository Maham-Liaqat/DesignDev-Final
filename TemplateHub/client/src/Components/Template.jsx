...
const Template = () => {
  ...
  const notifyForAccount = () => toast.error("Create an account on a platform?", {
    position: "top-center" 
  });

  if (!template) return <div>Loading...</div>;

  const HandleSourceCode = async (sourcePath) => {
    const token = localStorage.getItem('token');
    if (!token) {
      notifyForAccount();
    ...
    try {
      ...
      if (!template?.price || !template?.sellerName) {
      ...
      const paymentData = {
        ...
        sourcePath: sourcePath.replace(/\\/g, '/'), // Normalize to forward slashes
      ...
      // Consider adding more user-friendly error handling
    }
  };
  ...
  return (
    <div>
      <div className="bg-dark pb-9 pt-8 pt-md-11">
        <div className="container">
          <div className="row">
            <div className="col-lg-6 mb-5 mb-lg-0 position-relative">
              <h1 className="me-8 text-white">{template.templateName}</h1>
              <p className="me-xl-8 mb-5 text-white">
              ...
              <div className="d-md-flex align-items-center mb-6">
                ...
                <div className="ms-md-6">
                  ...
                  <div className="mb-2 d-flex align-items-center">
                    ...
                    <a href="#" className="font-size-sm text-white ms-3">
                      {template.category}
                    </a>
                  </div>
                  {reviews.map((review) => (
                    <div className="mb-2 d-flex align-items-center" key={review._id}>
                      <h6 className="mb-0 text-white font-size-sm">Review</h6>
                      <div className="d-flex align-items-center ms-3">
                        <div className="star-rating">
                          <div className="rating" style={{ width: `${(averageRating / 5) * 100}%` }}></div>
                        </div>
                        <div className="font-size-sm ms-3 text-white">
                          {/* <span>9.45 (9.8k+ reviews)</span> */}
                        </div>
                      </div>
                    </div>
                  ))}
                  <button className="btn btn-outline-light mt-2" onClick={handleMessageSeller}>
                    Message Seller
                  </button>
                </div>
              </div>
              ...
              <ul className="list-group list-group-flush">
                <li className="list-group-item d-flex align-items-center py-3 text-white bg-transparent border-white-10">
                  ...
                  <h6 className="mb-0 ms-3 me-auto text-white">Feature list</h6>
                  <span>Valid HTML5 / CSS3 | Based on Bootstrap 5</span>
                </li>
                <li className="list-group-item d-flex align-items-center py-3 text-white bg-transparent border-white-10">
                  <div className="text-white d-flex icon-uxs">
                    <svg
                    ...
                    >
                      <path
                        d="M15.7262 1.94825C13.4059 0.396725 10.401 0.315126 8.00002 1.73839C5.59897 0.315126 2.59406 0.396725 0.273859 1.94825C0.102729 2.06241 -3.54271e-05 2.25456 6.30651e-07 2.46027V14.6553C-0.000323889 14.8826 0.124616 15.0914 0.324917 15.1987C0.525109 15.3058 0.768066 15.294 0.94766 15.168C2.97546 13.8111 5.62138 13.8111 7.64919 15.168C7.6572 15.1735 7.66643 15.1747 7.67443 15.1796C7.68244 15.1846 7.69105 15.1932 7.70028 15.1987C7.72177 15.2079 7.74377 15.2159 7.76613 15.2227C7.78848 15.2329 7.81152 15.2415 7.83503 15.2486C7.86903 15.2564 7.90361 15.2616 7.93841 15.264C7.95626 15.264 7.97288 15.2714 7.99073 15.2714C7.99567 15.2714 8.00057 15.2714 8.00613 15.2714C8.02679 15.2699 8.0473 15.2672 8.06768 15.2634C8.09883 15.2602 8.1297 15.2547 8.15998 15.2467C8.18093 15.2399 8.20149 15.2319 8.22153 15.2227C8.24061 15.2147 8.26091 15.2104 8.27937 15.2006C8.28799 15.1956 8.29477 15.1883 8.30339 15.1827C8.312 15.1772 8.32185 15.1753 8.33046 15.1698C10.3583 13.8129 13.0042 13.8129 15.0321 15.1698C15.3141 15.3595 15.6965 15.2846 15.8861 15.0026C15.9551 14.9 16.0008 14.779 16 14.6554V2.46027C16 2.25456 15.8973 2.06241 15.7262 1.94825ZM7.38462 13.6036C5.43516 12.6896 3.18022 12.6896 1.23076 13.6036V2.79993C3.12732 1.67313 5.48806 1.67313 7.38462 2.79993V13.6036ZM14.7692 13.6036C12.8198 12.6896 10.5648 12.6896 8.61538 13.6036V2.79993C10.5119 1.67313 12.8727 1.67313 14.7692 2.79993V13.6036Z"
                        fill="currentColor"
                      ></path>
                    </svg>
                  </div>
                  <h6 className="mb-0 ms-3 me-auto text-white">Categories</h6>
                ...
                <li className="list-group-item d-flex align-items-center py-3 text-white bg-transparent border-white-10">
                  ...
                  <h6 className="mb-0 ms-3 me-auto text-white">Published</h6>
                  <span>
                  ...
                  <span>
                    {template.tags && template.tags.length > 0 ? (
                      template.tags.map(tag => (
                        <span key={tag} className="default-tag">{tag} </span>
                      ))
                    ) : (
                      <span className="no-tags">Html Css React</span>
                    )}
                  </span>
                </li>
                <li className="list-group-item d-flex align-items-center py-3 text-white bg-transparent border-white-10">
                ...
                <li className="list-group-item d-flex align-items-center py-3 text-white bg-transparent border-white-10">
                  ...
                  <h6 className="mb-0 ms-3 me-auto text-white">Icon-fonts:</h6>
                  <span>Free Bootstrap Icons by Bootstrap Icons.</span>
                </li>
                <li className="list-group-item d-flex align-items-center py-3 text-white bg-transparent border-white-10">
                  <div className="text-white d-flex icon-uxs">
                    <svg
                  ...
                  <h6 className="mb-0 ms-3 me-auto text-white">Tech Stack</h6>
                  <span>{template.techStack}</span>
                </li>
                <li className="list-group-item d-flex align-items-center py-4 bg-transparent border-white-10">
                  <a
                    href={template.demoURL}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="mx-auto text-white fw-medium d-flex align-items-center mt-2"
                  >
                    <svg
                      width="20"
                      height="20"
                    ...
                    <span className="ms-3">Preview this Template</span>
                  </a>
                </li>
              </ul>
            </div>
            ...
            <div className="col-lg-6">
              ...
              <div className="d-flex align-items-center mb-2">
                <ins className="h2 mb-0 text-white">PKR {template.price}</ins>
              </div>
              ...
              <div className="d-md-flex">
                <button
                  onClick={() => HandleSourceCode(template.sourceCode)}
                  className="btn btn-blue btn-wide mb-4 mb-md-0 me-md-3 flex-grow-1"
                  type="button"
                >
                  BUY NOW
                </button>
                ...
                <button
                  ...
                  className="btn btn-orange btn-wide mb-4 mb-md-0 ms-md-3 flex-grow-1"
                  type="button"
                  name="button"
                >
                  DEMO
      ...
      <div className="container">
        <div className="row pt-8">
          <div className="col-lg-10 col-xl-8 mx-lg-auto">
            <div className="mb-8">
              <h3 className="">Template Description</h3>
              <p className="mb-6 line-height-md">{template.shortDescription}</p>
              <p className="mb-6 line-height-md"></p>
              <p
                className="collapse mb-6 line-height-md"
                id="readcollapseExample"
              >
                {template.longDescription}
              </p>
              <a
                className="text-teal read-more h6 d-inline-block mb-8"
                data-bs-toggle="collapse"
                href="#readcollapseExample"
                role="button"
                aria-expanded="false"
              ...
              >
                <span className="d-inline-flex align-items-center more">
                  ...
                  <span className="d-flex align-items-center justify-content-center bg-teal rounded-circle ms-2 p-2 w-26p">
                    <i className="fas fa-plus font-size-10 text-white"></i>
                  </span>
                </span>
                <span className="d-inline-flex align-items-center less">
                  Read Less
                  <span className="d-flex align-items-center justify-content-center bg-teal rounded-circle ms-2 p-2 w-26p">
                    <i className="fas fa-minus font-size-10 text-white"></i>
                  </span>
                </span>
              </a>
            </div>
            ...
            <div className="mb-8">
              ...
              <p className="mb-6 line-height-md">{template.Intro}</p>
            </div>

            <div className="mb-8">
              <h3 className="mb-6">Buyer feedback</h3>
              <div className="row align-items-center mb-8">
                <div className="col-md-auto mb-5 mb-md-0">
                  <div className="border rounded shadow d-flex align-items-center justify-content-center px-9 py-8">
                    <div className="m-2 text-center">
                      <h1 className="display-2 mb-0 fw-medium mb-n1">{averageRating}</h1>
                      <h5 className="mb-0">Template rating</h5>
                      <div className="star-rating">
                        <div className="rating" style={{ width: `${(averageRating / 5) * 100}%` }}></div>
                      </div>
                    </div>
                ...
                <div className="col-md">
                  {[5, 4, 3, 2, 1].map((star) => (
                    <div key={star} className="d-md-flex align-items-center my-3 my-md-4">
                      <div
                        className="bg-gray-200 position-relative rounded-pill flex-grow-1 me-md-5 mb-2 mb-md-0 mw-md-260p"
                        style={{ height: "10px" }}
                      >
                        <div
                          className="bg-teal rounded-pill position-absolute top-0 left-0 bottom-0"
                          style={{ width: `${getRatingPercentage(star)}%` }}
                        ></div>
                      </div>
                      <div className="d-flex align-items-center">
                        <div className="star-rating star-rating-lg secondary me-4">
                          <div
                            className="rating"
  ...
  {reviews.map((review) => (
    <li className="media d-flex" key={review._id}>
     <div className="avatar avatar-xxl me-3 me-md-6 flex-shrink-0 bg-primary text-white d-flex align-items-center justify-content-center rounded-circle" style={{ width: "70px", height: "70px", fontSize: "28px" }}>
      ...
      <div className="media-body flex-grow-1">
        <div className="d-md-flex align-items-center mb-5">
          <div className="me-auto mb-4 mb-md-0">
            ...
            <p className="font-size-sm font-italic mt-0">{review.title}</p>
          </div>
          <div className="star-rating">
            <div
              className="rating"
        ...
        <p className="mb-6 line-height-xsm ">{review.content}</p>
